...
router.get('/', (req, res) => {
    ...
    .catch(error => {
        ...
        res.status(500).json({ errorMessage: 'Error in retrieving project information'})
    })
})
...
//Get a list of project actions for a specefic id
...
function validateProject(req, res, next) {
    if (Object.keys(req.body).length > 0) {
        ...
        res.status(500).json({errorMessage: "Could not save project to the existing database"})
    }
}
